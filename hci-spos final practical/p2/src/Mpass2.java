...
public class Mpass2 {
	...
	public static void main(String[] args) throws IOException {
		...
		int macro_addr = -1;
	 	...
	 	BufferedReader br1=new BufferedReader(new FileReader("C:/Users/91832/Documents/Downloads/Macro2/src/MNT.txt"));
	 	String line;
		...
		br1=new BufferedReader(new FileReader("C:/Users/91832/Documents/Downloads/Macro2/src/argmnt.txt"));
	 	while((line = br1.readLine())!=null)
	 	{
		...
		br1=new BufferedReader(new FileReader("C:/Users/91832/Documents/Downloads/Macro2/src/MDT.txt"));
	 	while((line = br1.readLine())!=null)
	 	{
	 		MDT[mdt_cnt]=new mdt();
		...
		br1=new BufferedReader(new FileReader("C:/Users/91832/Documents/Downloads/Macro2/src/input4.txt"));
		arglist[] actual_parameter=new arglist[10];
		
		BufferedWriter bw1 = new BufferedWriter(new FileWriter("C:/Users/91832/Documents/Downloads/Macro2/src/output4.txt"));
	 	while((line = br1.readLine())!=null)
	 	{
